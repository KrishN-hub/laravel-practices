          ...
          >
            ...
            >
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ url('pages/about') }}">
                    <svg class="bi" aria-hidden="true">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ url('mental/photo') }}">
                    <svg class="bi" aria-hidden="true">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ url('pages/content') }}">
                    <svg class="bi" aria-hidden="true">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ url('pages/employee/employee-form') }}">
                    <svg class="bi" aria-hidden="true">
